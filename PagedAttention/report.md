...
<span style="color: #6ebffb">程序逻辑页 (Logical Page)</span> ->
<span style="color: #6eff6e">物理内存页 (Physical Page)</span>
</li>
<li class="text list"><b>vLLM 的工作</b>:
<span style="color: #6ebffb">请求逻辑块 (Logical Block)</span> ->
<span style="color: #6eff6e">GPU 物理块 (Physical Block)</span>
</li>
...
<li class="text list" style="font-size: 1.2rem; color: #6eff6e;"><b>结论</b>：内存浪费 (内部碎片) 仅限于最后一个块</li>
</div>
...
<li class="text list" style="font-size: 1.2rem; color: #6eff6e;"><b>结果</b>：极低的复制开销 (仅一个块)，节省了长 Prompt 的大量内存</li>
</div>
